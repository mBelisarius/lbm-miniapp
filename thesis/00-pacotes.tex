...
\SetKw{De}{de}
\SetKw{Ate}{até}
\SetKw{FimPara}{fim para}
\SetKw{Enquanto}{enquanto}
\SetKw{FimEnquanto}{fim enquanto}
...
\usepackage[style=abnt,backref=true,backend=biber,citecounter=true,backrefstyle=three,language=brazilian]{biblatex}
