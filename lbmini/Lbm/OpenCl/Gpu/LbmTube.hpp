...
protected:
  ...
  void streamAndMacroscopic(const cl::Buffer& fIn, const cl::Buffer& gIn, const cl::Buffer& fOut, const cl::Buffer& gOut, cl_command_buffer_khr_ptr cb, cl_command_queue q, const size_t* gws, const size_t* lws) {
      int arg = 0;
