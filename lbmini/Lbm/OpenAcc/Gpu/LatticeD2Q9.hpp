#ifndef LBMINI_OPENACC_GPU_LATTICED2Q9_HPP_
#define LBMINI_OPENACC_GPU_LATTICED2Q9_HPP_
 ...
 * `lbmini::openacc::cpu::LatticeD2Q9`. Helpers are stateless, `static constexpr`
 * / `static`, so the class is trivially callable from inside an
 * `#pragma acc parallel loop` region — the only GPU
...
#endif // LBMINI_OPENACC_GPU_LATTICED2Q9_HPP_
