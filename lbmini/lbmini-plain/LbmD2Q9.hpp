#ifndef LBMINI_LBMD2Q9_HPP_
#define LBMINI_LBMD2Q9_HPP_
...
private:
  // Constants
  inline static const Scalar_ kTiny_ = Scalar_(10.e-14);
  ...
  inline static const Vector<Scalar_, Speeds()> kWeights_{
    // Rest weight
    Scalar_(4.0) / Scalar_(9.0),
    // Face-centered directions
    Scalar_(1.0) / Scalar_(9.0),
    Scalar_(1.0) / Scalar_(9.0),
    Scalar_(1.0) / Scalar_(9.0),
    Scalar_(1.0) / Scalar_(9.0),
    // Edge-centered directions
    Scalar_(1.0) / Scalar_(36.0),
    Scalar_(1.0) / Scalar_(36.0),
    Scalar_(1.0) / Scalar_(36.0),
    Scalar_(1.0) / Scalar_(36.0),
  };
